...
// Remove this line: import net.minecraft.commands.CommandRuntimeException;
...
public class ClientCommands {
    ...
    public static int executeCommand(StringReader reader) {
        ...
        try {
            ...
            ClientCommand.sendFeedback("Syntax error: " + e.getMessage(), ChatFormatting.RED, false);
            e.printStackTrace();
        } catch(Exception e) {
            ClientCommand.sendFeedback("Unknown error executing command", ChatFormatting.RED, false);
            e.printStackTrace();
        }
    ...
    public static class FakeCommandSource extends CommandSourceStack {
        ...
        public Collection<String> getOnlinePlayerNames() {
            if (Minecraft.getInstance().getConnection() == null) return List.of();
